...
class Lightingtools extends StatefulWidget {
  const Lightingtools({super.key});

  @override
  State<Lightingtools> createState() => _LightingtoolsState();
}

class _LightingtoolsState extends State<Lightingtools> {
  @override

   void initState() {
    super.initState();
    AppCubitCubit.get(context).getCategoryLightingtools();
  }
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.yellow[700],
        title: const Text('Lighting tools' , style: TextStyle(fontWeight: FontWeight.bold),),
      ),
