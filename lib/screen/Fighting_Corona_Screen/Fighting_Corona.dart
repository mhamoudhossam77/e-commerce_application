...
class  FightingCorona extends StatefulWidget {
  const FightingCorona({super.key});

  @override
  State<FightingCorona> createState() =>
      _ElectronicDevicesScreenState();
}

class _ElectronicDevicesScreenState extends State<FightingCorona> {
  @override
  void initState() {
    super.initState();
    AppCubitCubit.get(context).getCategoryFightingCorona();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Fighting Corona' , style: TextStyle(fontWeight: FontWeight.bold),),
      ),
